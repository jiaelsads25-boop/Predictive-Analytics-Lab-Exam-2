...
print(f'  Class counts              : No={counts["No"]}, Yes={counts["Yes"]}')
print(f'  Class imbalance ratio     : {counts["No"]/counts["Yes"]:.2f}:1 (No:Yes)')
print(f'  Feature1 range            : [{df["Feature1"].min():.4f}, {df["Feature1"].max():.4f}]')
print(f'  Feature2 range            : [{df["Feature2"].min():.0f}, {df["Feature2"].max():.0f}]')
print(f'  Feature1-Target corr.     : {corr.loc["Feature1","Target_bin"]:.3f}')
print(f'  Feature2-Target corr.     : {corr.loc["Feature2","Target_bin"]:.3f}')
